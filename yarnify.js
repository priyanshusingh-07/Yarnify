...
// let date=new Date("03/01/2024");
// document.getElementById("cuttentDate").innerHTML="Date- "+date.toLocaleDateString();
...
function addItem() {
    ...
    newRow.innerHTML = `
        <td><input type="number" class="serialNumber" placeholder="Serial No."></td>
